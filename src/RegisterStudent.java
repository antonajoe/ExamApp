...
public class RegisterStudent extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(900, 497));
        ...
        jLabel2.setText("Enter the Exam id:");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        Exam newExam = new AccessExams(id).getExam();
        newExam.setStudent(name);
        newExam.setIsRegistered(1);
        ExamApp.database.updateExam(newExam);
        jLabel3.setText("Student is registered!");
        jTextField1.setText("");
        jTextField2.setText("");
